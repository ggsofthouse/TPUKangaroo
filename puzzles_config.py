...
PUZZLES = {
    ...
    70: {
        ...
        "address": "19YZECXj3SxEZM-oUeJ1yiPsw8xANe7M7QR",
        "reward": "0.70 BTC"
    },
    80: {
        "range": 80,
...
def print_colab_command(puzzle_num: int, backend: str = "tpu", kangaroos: int = 131072):
    if puzzle_num not in PUZZLES:
        print(f"Puzzle #{puzzle_num} não encontrado.")
        return
    p = PUZZLES[puzzle_num]
    cmd = f"""
# ==============================================================================
# 🦘 GOOGLE COLAB LAUNCH COMMAND FOR BITCOIN PUZZLE #{p['range']} ({p['reward']})
# ==============================================================================
%cd /content
!rm -rf TPUKangaroo
...
if __name__ == "__main__":
    import sys
    puzzle_id = int(sys.argv[1]) if len(sys.argv) > 1 else 20
    print_colab_command(puzzle_id)
